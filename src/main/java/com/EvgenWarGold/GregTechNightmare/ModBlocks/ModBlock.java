...
public class ModBlock {
    ...
    protected ModBlock(@NotNull String modID, @NotNull String unlocalizedName, @NotNull String localizedName,
        int meta) {
        this.modID = modID;
    ...
    protected ModBlock(@NotNull Mods mod, @NotNull String unlocalizedName, @NotNull String localizedName, int meta) {
        this(mod.ID, unlocalizedName, localizedName, meta);
    }

    protected ModBlock(@NotNull Mods mod, @NotNull String unlocalizedName, @NotNull String localizedName) {
