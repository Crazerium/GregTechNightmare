...
public class ModItem {
    ...
    protected ModItem(@NotNull Mods mod, @NotNull String unlocalizedName, @NotNull String localizedName, int meta) {
        this(mod.ID, unlocalizedName, localizedName, meta);
    }

    protected ModItem(@NotNull Mods mod, @NotNull String unlocalizedName, @NotNull String localizedName) {
